...
flags.DEFINE_string('image_data_dir', '/opt/Downloads/Flicker8k_Dataset', 'Root directory to raw pet dataset.')
flags.DEFINE_string('output_dir', '/opt/Downloads/', 'Path to directory to output TFRecords.')
flags.DEFINE_string('label_map_path', '/opt/Downloads/Flicker8k_test/Flickr8k.token.txt',
                    'Path to label map')
FLAGS = flags.FLAGS
